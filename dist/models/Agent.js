...
], Agent.prototype, "roles", void 0);
__decorate([
    (0, typegoose_1.prop)(),
    (0, type_graphql_1.Field)(() => [String], { nullable: true }),
    __metadata("design:type", Array)
], Agent.prototype, "accessVendors", void 0);
Agent = __decorate([
    (0, type_graphql_1.ObjectType)({ description: "The Agent model" })
], Agent);
exports.Agent = Agent;
const agentSchema = new mongoose_1.Schema({
    ...
    password: String,
    roles: [String],
    accessVendors: [{ type: mongoose_1.default.Types.ObjectId, ref: "Vendor" }],
});
